...
for y in time_period:
    pos.view_phrase_sentences(y, nouns, flat_sentences, metadata_dict, sentence_record_dict, output_data = False)
...
nouns_3y = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                               nlp, 
                                                               heat_pump_phrases['noun_phrase_hp'], 
                                                               3))
time_period = '2019, 2020, 2021' 
pos.view_phrase_sentences_period(time_period, nouns_3y, flat_sentences, metadata_dict, sentence_record_dict)
...
for y in time_period:
    pos.view_phrase_sentences(y, adjectives, flat_sentences, metadata_dict, sentence_record_dict)
...
# %%
time_period = '2019, 2020, 2021' 
pos.view_phrase_sentences_period(time_period, hp_are, flat_sentences, metadata_dict, sentence_record_dict)
...
pos.view_phrase_sentences_period(time_period, hp_can, flat_sentences, metadata_dict, sentence_record_dict)
...
# %%
# To view full sentences that use the verb phrases including links to original articles:
pos.view_phrase_sentences_period(time_period, hp_have, flat_sentences, metadata_dict, sentence_record_dict)
...
# %%
# To view full sentences that use the verb phrases including links to original articles:
pos.view_phrase_sentences_period(time_period, verbs_follow, flat_sentences, metadata_dict, sentence_record_dict)
...
# %%
# To view full sentences that use the verb phrases including links to original articles:
pos.view_phrase_sentences_period(time_period, verbs_precede, flat_sentences, metadata_dict, sentence_record_dict)
...
pos.save_phrases([nouns, adjectives, verbs_follow, verbs_precede]).to_csv(DISC_OUTPUTS_DIR / "pos_phrases.csv",
                                                                         index = False)
