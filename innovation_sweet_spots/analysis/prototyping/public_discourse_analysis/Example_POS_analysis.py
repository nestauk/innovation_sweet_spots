...
# %%
from innovation_sweet_spots.utils import \
    pd_pos_utils as pos
...
term_phrases = pos.noun_chunks_w_term(noun_chunks_all_years, search_terms) # invididual years
...
nouns = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                               nlp, 
                                                               heat_pump_phrases['noun_phrase_hp'], 
                                                               3))
#nouns[time_period]

# %%
# To view full sentences that use the noun phrases including links to original articles:
pos.view_phrase_sentences(time_period, nouns, flat_sentences, metadata_dict, sentence_record_dict)
...
adjectives = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                                    nlp, 
                                                                    heat_pump_phrases['adj_phrase_hp'], 
                                                                    3))


# %%
# To view full sentences that use the adjective phrases including links to original articles:
time_period = '2016, 2017, 2018'
pos.view_phrase_sentences(time_period, adjectives, flat_sentences, metadata_dict, sentence_record_dict)
...
hp_are = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                                nlp, 
                                                                heat_pump_phrases['term_is_hp'], 
                                                                3))

# %%
# To view full sentences that use the verb phrases including links to original articles:
time_period = '2013, 2014, 2015'
pos.view_phrase_sentences(time_period, hp_are, flat_sentences, metadata_dict, sentence_record_dict)

# %%
# Phrases that match the pattern 'heat pumps can ...'
hp_can = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                                nlp, 
                                                                heat_pump_phrases['term_can_hp'], 
                                                                3))

# %%
# To view full sentences that use the verb phrases including links to original articles:
pos.view_phrase_sentences(time_period, hp_can, flat_sentences, metadata_dict, sentence_record_dict)

# %%
# Phrases that match the pattern 'heat pumps have ...'
hp_have = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                                nlp, 
                                                                heat_pump_phrases['term_have_hp'], 
                                                                3))

# %%
# To view full sentences that use the verb phrases including links to original articles:
pos.view_phrase_sentences(time_period, hp_have, flat_sentences, metadata_dict, sentence_record_dict)

# %%
# Verbs that follow heat pumps.
verbs_follow = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                                     nlp, 
                                                                     heat_pump_phrases['verb_subj_hp'], 
                                                                     3))

# %%
# To view full sentences that use the verb phrases including links to original articles:
pos.view_phrase_sentences(time_period, verbs_follow, flat_sentences, metadata_dict, sentence_record_dict)

# %%
# Phrases where verbs precede heat pumps.
verbs_precede = pos.aggregate_matches(pos.match_patterns_across_years(combined_term_sentences, 
                                                                      nlp, 
                                                                      heat_pump_phrases['verb_obj_hp'], 
                                                                      3))

# %%
# To view full sentences that use the verb phrases including links to original articles:
pos.view_phrase_sentences(time_period, verbs_precede, flat_sentences, metadata_dict, sentence_record_dict)
