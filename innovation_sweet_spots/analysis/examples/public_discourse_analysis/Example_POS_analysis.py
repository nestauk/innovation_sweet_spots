...
nouns = pos.aggregate_matches(
    pos.match_patterns_across_years(
        combined_term_sentences, nlp, heat_pump_phrases["noun_phrase_hp"], 1
    )
)
...
nouns_3y = pos.aggregate_matches(
    pos.match_patterns_across_years(
        combined_term_sentences, nlp, heat_pump_phrases["noun_phrase_hp"], 3
    )
)
time_period = "2019, 2020, 2021"
...
adjectives = pos.aggregate_matches(
    pos.match_patterns_across_years(
        combined_term_sentences, nlp, heat_pump_phrases["adj_phrase_hp"], 1
    )
)
...
hp_are = pos.aggregate_matches(
    pos.match_patterns_across_years(
        combined_term_sentences, nlp, heat_pump_phrases["term_is_hp"], 3
    )
)
...
hp_can = pos.aggregate_matches(
    pos.match_patterns_across_years(
        combined_term_sentences, nlp, heat_pump_phrases["term_can_hp"], 3
    )
)
...
hp_have = pos.aggregate_matches(
    pos.match_patterns_across_years(
        combined_term_sentences, nlp, heat_pump_phrases["term_have_hp"], 3
    )
)
...
verbs_precede = pos.aggregate_matches(
    pos.match_patterns_across_years(
        combined_term_sentences, nlp, heat_pump_phrases["verb_obj_hp"], 3
    )
)
