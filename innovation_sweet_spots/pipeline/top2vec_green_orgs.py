...
SEED = 11111
SESSION_SUFFIX = "July2021_cb_world_orgs_stopwords_e400"
...
if __name__ == "__main__":
    ...
    cb_uk_corpus, green_orgs_uk = get_green_cb_docs_by_country(country=None)
    documents = cb_uk_corpus
    ...
    doc_ids = green_orgs_uk.id.to_list()
