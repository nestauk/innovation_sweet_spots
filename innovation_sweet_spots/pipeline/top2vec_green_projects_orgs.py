...
SEED = 11111
SESSION_SUFFIX = "July2021_projects_orgs_stopwords_e400"
...
if __name__ == "__main__":
    ...
    documents = list(green_docs.values()) + cb_uk_corpus
    ...
    doc_ids = list(green_docs.keys()) + green_orgs_uk.id.to_list()
    ...
    result_table = pd.DataFrame(
        data={
            ...
            "source": ["gtr"] * len(green_docs) + ["cb"] * len(cb_uk_corpus),
        }
